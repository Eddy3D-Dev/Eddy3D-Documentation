...
<div class="index-quicklink-container">
    <a href="/components/Select_Template/" style="text-decoration: none;">
        <div class="index-quicklink">
            ...
            <div class="index-quicklink-text">Load example Grasshopper definitions for common workflows.  Templates include microclimate simulations, outdoor comfort studies, and CFD analysis setups.  Version: 1.6.0.827</div>
        </div>
    </a>
</div>
