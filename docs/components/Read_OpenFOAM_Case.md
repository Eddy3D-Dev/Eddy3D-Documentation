...
| ---- | -------- | ----------- |
| Dir |  | Directory containing the OpenFOAM case. |

#### Output

| Name | Nickname | Description |
| ---- | -------- | ----------- |
| Files |  | File containers found in the case. |
| Ignored Files | I | Names of files in the directory that were not added to the case. |
