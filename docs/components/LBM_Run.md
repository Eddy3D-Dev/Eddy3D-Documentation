...
| ---- | -------- | ----------- | ---- |
| Working Directory | Dir | Parent directory for named LBM cases (optional; default ~/Eddy3D/Cases/LBM). Must not contain spaces because the case is mounted into the container. | `Text` |
| Case Name | Case | Case folder name below Working Directory. Letters, numbers, hyphens, and underscores only. | `Text` |
