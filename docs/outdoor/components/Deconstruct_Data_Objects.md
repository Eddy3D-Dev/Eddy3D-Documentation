...
Data
* ##### S 
Select the hours you would like to process. Select "-1" to process the entire year (8760 h) if you are working with a temporal object, or all existing wind directions if you are working with a spatial object.
