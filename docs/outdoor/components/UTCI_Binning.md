## ![UTCI Binning Icon](../images/icons/UTCI_Binning.png) UTCI Binning

![UTCI Binning Component](../images/components/UTCI_Binning-crop.png)

Condition of person rating in bins. Order is as follows:
...
#### Input
* ##### Cond 
UTCI Condition of Person

#### Output
* ##### Bins
Condition of person rating in bins.
* ##### CH
Comfortable Hours [%] (No Stress Condition).