## ![Point Probe Inspector Icon](../images/icons/Point_Probe_Inspector.png) Point Probe Inspector

![Point Probe Inspector Component](../images/components/Point_Probe_Inspector-crop.png)
