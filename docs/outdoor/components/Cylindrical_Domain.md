## ![Cylindrical Domain Icon](../images/icons/Cylindrical_Domain.png) Cylindrical Domain

![Cylindrical Domain Component](../images/components/Cylindrical_Domain-crop.png)
