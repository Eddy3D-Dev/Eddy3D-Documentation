## ![Mean Radiant Temperature Icon](../images/icons/Mean_Radiant_Temperature.png) Mean Radiant Temperature

![Mean Radiant Temperature Component](../images/components/Mean_Radiant_Temperature-crop.png)
